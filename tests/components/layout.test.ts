/**
 * T36 — Component test stubs: Layout components.
 *
 * Verifies that layout and provider components:
 *   1. Are importable without throwing
 *   2. Export a default export (React component)
 *
 * These are structural tests — they do NOT render the components.
 * Full rendering tests require more complex mocking of Next.js internals.
 */
...
describe("SessionProvider component — module structure", () => {
  it("is importable and exports a default component", async () => {
    const module = await import("@/components/providers/SessionProvider");
    expect(module.default).toBeDefined();
    expect(typeof module.default).toBe("function");
  });
});
