    ...
    <>
      ...
      <main className="min-h-screen">
        ...
        <section
          ...
          style={{
            background:
              "linear-gradient(135deg, #7c2d12 0%, #9a3412 15%, #c2410c 30%, #ea580c 50%, #f97316 65%, #fb923c 78%, #fbbf24 92%, #f59e0b 100%)",
          }}
        >
          ...
          >
            ...
            <div className="absolute -bottom-32 -left-16 w-80 h-80 rounded-full bg-black/10 blur-3xl" />
            <div className="absolute top-1/3 left-1/4 w-64 h-64 rounded-full bg-yellow-400/10 blur-2xl" />
            {/* Decorative lotus-like rings */}
