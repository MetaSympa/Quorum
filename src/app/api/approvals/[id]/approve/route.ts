 ...
 *
 * Approve a pending approval entry. Admin only.
 *
 * Body: { notes?: string }
 *
 * Applies the proposed change to the database atomically.
...
import { approveEntry } from "@/lib/services/approval-service";
