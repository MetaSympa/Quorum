...
export default function Sidebar({ user, onNavigate }: SidebarProps) {
  ...
  return (
    <div className="flex h-full w-72 flex-col bg-[radial-gradient(circle_at_top,_rgba(56,189,248,0.18),_transparent_18rem),linear-gradient(180deg,#0f172a_0%,#111c38_52%,#0f172a_100%)] text-white">
      <SidebarBrand />
